...
tool_id: tftp-hpa
title: tftp-hpa
categories: ["system-services", "utilities"]
category_slugs: ["system-services", "utilities"]
homepage: https://git.kernel.org/pub/scm/network/tftp/tftp-hpa.git/
repository: 
version: 5.3+20251110-1
architectures: any
license: 
binaries: []
metapackages: ["kali-linux-default kali-linux-everything kali-linux-headless kali-linux-large"]
icon: /images/kali-tools-icon-missing.svg
source_path: kali-tools\tftp-hpa\index.md
source_commit: 6a986bc96e156a34ddc47f758a4449202a8e475d
generated_at: 2026-01-03T15:46:07.140249
---

# Tool: tftp-hpa (tftp-hpa)
...
| Field | Value |
| --- | --- |
| Homepage | [https://git.kernel.org/pub/scm/network/tftp/tftp-hpa.git/](https://git.kernel.org/pub/scm/network/tftp/tftp-hpa.git/) |
| Repository |  |
| Version | 5.3+20251110-1 |
| Architectures | any |
| License |  |
...
- **Repository**: https://salsa.debian.org/debian/tftp-hpa
- **PackagesInfo**: |
...
## Source
- Path: kali-tools\tftp-hpa\index.md
- Commit: 6a986bc96e156a34ddc47f758a4449202a8e475d
- Generated at: 2026-01-03T15:46:07.140249
